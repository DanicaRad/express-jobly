...
describe("findAll", function () {
  ...
  test("works: with filter", async function() {
    let companies = await Company.findAll({name: "c1", minEmployees: "1", maxEmployees: undefined});
    expect(companies).toEqual([
      {
        handle: "c1",
        name: "C1",
...
describe("get", function () {
  test("works: no jobs associated w/company", async function () {
  ...
  test("works: with job listings", async function () {
